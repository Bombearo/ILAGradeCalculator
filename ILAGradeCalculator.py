...
def Handins(arr):
	...
	return float(sum(float v for i in listdiv)/30)*100
...
def Main():
	...
	print("For Hand-ins, you have"+str(float(handin_results/100)*30)+"% out of the 30% available")
	...
	if synoptic:
		...
		print("For the synoptic test, you have"+str(synoptic_results*100)+"%")
